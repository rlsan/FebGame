namespace TexturePackerLoader
{
  ...
  public class SpriteRender
  {
    ...
    public void Draw(SpriteFrame sprite, Vector2 position, Color? color = null, float rotation = 0, float scaleX = 1, float scaleY = 1, SpriteEffects spriteEffects = SpriteEffects.None)
    {
      ...
      spriteBatch.Draw(
          ...
          rotation: rotation,
          origin: origin,
          scale: new Vector2(scaleY, scaleX),
